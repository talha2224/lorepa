export const guestFAQs = [
  ...
  },
  {
    ...
    answer: "No. You are required to provide valid auto insurance that covers towing. Additional optional protection may be offered during checkout.",
  },
  {
...
export const hostFAQs = [
  ...
  },
  {
    ...
    answer: "You must maintain valid trailer insurance. Lorepa does not provide direct coverage to owners. However, optional protection programs may be introduced in future.",
  },
  {
    question: "Can I choose who rents my trailer?",
    answer: "Yes. You can review the renter’s profile, documents, and ratings before a request. You are under no obligation to accept every booking.",
  },
  {
  ...
  },
  {
    ...
    answer: "Absolutely. Lorepa supports multiple listings per user. You can manage your fleet under one account and adjust availability per unit.",
  },
  {
...
export const globalFAQs = [
  ...
  },
  {
    ...
    answer: "Currently, Lorepa does not directly offer insurance but may require proof of third-party coverage (FAQ27). Dedicated insurance options may be added soon.",
  },
  {
