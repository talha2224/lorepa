...
const ReservationItem = ({ image, title, date, renter, status, details }) => (
  <div className="flex space-x-3 py-3 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition duration-150 rounded-lg p-2 -mx-2">
    ...
    <div className="flex-grow min-w-0">
      ...
      {/* Status Badge */}
      {status && (
        <span className={`inline-flex items-center px-2 py-0.5 mt-1 rounded-full text-xs font-medium ${status === 'Active' ? 'bg-blue-100 text-blue-800' :
    ...
    <div className="flex flex-col justify-between items-end">
      <button className="text-blue-600 hover:text-blue-800 text-xs font-medium flex-shrink-0">
        {details}
      </button>
      <FaEllipsisV className='w-4 h-4 text-gray-400 cursor-pointer hover:text-gray-600 flex-shrink-0 mt-2' title="More Options" />
    </div>
  </div>
);

// Mock Chart Component (Simulating the line chart shape with SVG for the Revenue Overview)
const RevenueChart = () => (
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md transition duration-300 hover:shadow-lg">
            <div className="flex justify-between items-center mb-4 border-b border-gray-100 pb-4">
              ...
              <a href="#" className="text-blue-600 text-sm font-medium hover:text-blue-800 transition duration-150">View all</a>
            </div>
            <div className="divide-y divide-gray-100">
              <ReservationItem
                image={trailer1}
                title="2017 Diamond C Utility 77\"
                date="Jan 5 - Jan 10, 2025"
                renter="James R."
                status="Active"
              ...
              <ReservationItem
                image={trailer2}
                title="2019 PJ Low Profile Gooseneck"
                date="Jan 5 - Jan 10, 2025"
                renter="James R."
                status="Pending"
                details="View Details"
              ...
              <ReservationItem
                image={trailer3}
                title="2020 Sure-Trac Dump Trailer"
                date="Jan 5 - Jan 10, 2025"
                renter="James R."
                status={null}
                details="View Details"
