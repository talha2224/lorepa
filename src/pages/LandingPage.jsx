    ...
    <div className="w-screen min-h-screen bg-[#fff] flex flex-col overflow-x-hidden">
      ...
      <div style={{ backgroundImage: `url(${Hero})` }} className="relative min-h-screen w-screen bg-cover">
        <motion.div variants={zoomBounce} initial="hidden" animate="visible" className="w-full flex justify-center items-center flex-col">
          ...
          <motion.div variants={blurIn} initial="hidden" animate="visible" className="rounded-md p-3 sm:w-[80%] w-[90%] mx-20 my-10 md:flex justify-center items-center flex-wrap bg-white md:bg-white bg-opacity-10 backdrop-blur-md shadow-lg md:backdrop-blur-0 md:bg-opacity-100">
